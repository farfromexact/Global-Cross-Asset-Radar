...
> 数据截点：北京时间2026-08-22 19:36。今天是周六，中国商品期货/期权没有日盘或21:00夜盘；最新完整中国交易日为2026-08-21。标准WTI、Brent、COMEX银等也处周末停盘期，因此不把任何旧报价冒充15:00—19:30实时价格。本版采用8月21日EOD + 8月22日周末新闻，下一中国价格发现窗口为8月24日09:00。
...
| Rank | 机会 | Score | 方向/持有 | 阶段 | Fresh层 | 惩罚 |
|---:|---|---:|---|---|---:|---|
| **1** | **FU2611 周一回撤确认多** | **79** | 多 / 1–5D | 条件试仓 | 4 | Physical缺、weekend gap、exec N |
| **2** | **AG2610 周一回撤确认多** | **76** | 多 / 1–5D | 条件试仓 | 3 | curve弱、IV贵、exec N |
| **3** | **FG701 失败反弹空** | **74** | 空 / 1–5D | 条件试仓 | 3 | Physical仅level、动态参数缺 |
| 4 | BU2610 能源趋势多 | 72 | 多 / 1–5D | 条件单 | 4 | 与FU重复、OI弱 |
| 5 | EC2610 极端动量 | 69 | 观察 / 1–3D | 观察 | 2 | 过热、闭环不足 |

## 七、前三名交易卡

### FU2611｜79｜回撤确认多
事实：3850结算、1D+2.12%、5D+9.81%、ΔOI+8.58%、Bwd约7.47%、ATM IV约43% vs RV20约37.93%。市场已计入大量供应风险；周末新闻提高gap概率，不提高追价赔率。最佳表达先期货确认，若周一夜盘仍成立再比较2026-10-19 expiry 35–45Δ Call / 15–25Δ Call Spread；`execution_ready=false`，不报权利金。

8月24日09:00后等30–45分钟；3810–3850守住并重新接受3850上方，先1/3风险；gap-up约2%以上且不回测则放弃。有效跌破3810并伴curve压缩失效。TP1 +1R，TP2 +2R或curve收窄约1/3；两交易时段无延续撤。最大损失0.35%–0.50% NAV，FU+BU合并初始≤0.75%。参数：10吨/手，tick 1元/吨，tick value 10元，名义约38,500元；8/21可核实限价14%、一般保证金16%、套保15%，券商保证金未确认；1板约5,390元/手，两板复合约11,535。常规夜盘21:00–23:00，周六无盘。

### AG2610｜76｜回撤确认多
事实：16771/16611，1D+3.11%、5D+5.45%、ΔOI+1.46%，ATM IV47.27%、RR25+7.81，Vega明显昂贵。最佳表达为小期货确认或核价后的2026-09-23 Call Spread，不裸买gap-up ATM Call。

8月24日09:00等15–30分钟，16600/16611守住并重新站稳16770且海外金银重开不反向；30分钟接受16600下且外盘同步回吐止损。TP1/TP2=+1R/+2R；最大损失0.35%–0.55% NAV。15kg/手，tick value15元，名义约251,565元；8/21动态限价14%、一般16%、套保15%；常规夜盘21:00–02:30，周六无盘。

### FG701｜74｜失败反弹空
事实：907/906，1D-1.09%、5D-3.10%、ΔOI+10.21%、Contango约-3.35%；周度库存7441.4重量箱只是level context。8月24日09:00等30分钟，910–918反弹失败且curve不收窄后空，重新跌破899才加；30分钟站稳920止损。TP1=899，TP2=880附近或+2R；两交易日不破899撤；最大损失0.25%–0.40% NAV。20吨/手、tick value20元、名义约18,120元；动态保证金/涨跌停本轮未充分确认，不虚构压力金额；常规夜盘21:00–23:00，周六无盘。
